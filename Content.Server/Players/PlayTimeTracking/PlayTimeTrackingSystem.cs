...
public sealed class PlayTimeTrackingSystem : EntitySystem
{
    ...
    public bool IsAllowed(ICommonSession player, string role)
    {
        ...
        return JobRequirements.TryRequirementsMet(job, playTimes, out _, EntityManager, _prototypes, (HumanoidCharacterProfile?) _preferencesManager.GetPreferences(player.UserId).SelectedCharacter, sponsorTier, uuid);   //LP edit
    }
    ...
    public void RemoveDisallowedJobs(NetUserId userId, List<ProtoId<JobPrototype>> jobs)
    {
        ...
        //LP edit start
        var uuid = SponsorSimpleManager.GetUUID(userId);
